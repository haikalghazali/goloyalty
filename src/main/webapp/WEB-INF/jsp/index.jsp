        ...
        <div class="app">            
            <header id="header" style="background-image: url('assets/images/landing/header_background.jpg');">
                ...
                <div class="header-content">
                    <div class="container text-center invert">
                        <h1>Boooya &mdash; Revolution Admin Template</h1>
                        <div class="under-heading">The best solution for your web app for only $24</div>                        
            ...
            <section class="section section-highlight" id="contact">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="feature feature-icon-offset">
                                <div class="feature-icon text-darkblue-500">
                                    <span class="fa fa-paper-plane-o"></span>
                                </div>
                                <div class="heading-wrapper">                                                                
                                    <h6 class="text-uppercase text-bolder">Contact Us</h6>
                                    <div class="under-heading">Let us know if you have questionr or suggestions</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row margin-top-20">
                                    <div class="col-md-12">
                                        <textarea class="form-control" name="text" placeholder="Your message..." rows="5"></textarea>
                                    </div>
                                </div>
                                <div class="row margin-top-20">
                                    <div class="col-md-12">
                                        <button class="btn btn-success btn-lg btn-shadowed">Send message</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-md-offset-1">
                            <div class="feature feature-icon-offset">
                                ...
                                <div class="heading-wrapper">                                                                
                                    <h6 class="text-uppercase text-bolder">Best Support Ever</h6>
                                    <div class="under-heading">Free support for all customers</div>
                                </div>                            
                            </div>
                            <p>We provide absolutely <span class="bold">free support</span> for our customers.</p>                            
                            <p>All <strong>updates</strong> of our template also absolutely <span class="bold">free</span>, and can be downloaded from themeforest after release.</p>
                            <p>Also do not hesitate to <span class="bold">send your questions or suggestions</span>. We appreciate your help, and we will do our best to make template better.</p>
                            <p class="text-right margin-top-20"><a href="#" class="btn btn-danger btn-lg btn-shadowed">Buy it for only $24</a></p>
                        </div>
                    </div>                    
                </div>
            </section>            
            ...
            <div class="app-footer app-footer-default" id="footer">
                ...
                <div class="app-footer-line darken">                
                    <div class="copyright wide text-center">&copy; 2018 Go+ Loyalty. All right reserved.</div>                
                </div>                
            </div>
            <!-- END APP FOOTER -->
